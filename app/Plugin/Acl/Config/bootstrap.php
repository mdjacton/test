...
/*
 * The model name used for the user group (typically 'Group' or 'Group')
 */
 ...
 */
Configure :: write('acl.aro.group.primary_key', '');
 ...
 */
Configure :: write('acl.aro.group.foreign_key', '');
 ...
 */
Configure :: write('acl.aro.group.display_field', 'name');
 ...
 */
Configure :: write('acl.gui.groups_permissions.ajax', true);
